...
def speed_forecast_2h(start_time=):

    boro_sel = ['Manhattan','Staten Island','Queens','Bronx','Brooklyn']
    freq = '15min'
    ampm = 'morning'
    df = clean.load_speed_from_api(start_time=start_time)
    ...
    data_in = format_data_in_2h(ampm,median_speed,df_weather,df_weather_pred)
